...
public class Hotel {
	...
	public ArrayList<Servicio> getServicios() throws IOException{
		this.cargarServicios();
		return servicios;
	}
...
private void cargarHabitaciones() throws IOException {
	...
	public ArrayList<Habitacion> getInventario() throws IOException{
		this.cargarHabitaciones();
		return inventario;
	}
	...
	public ArrayList<Reserva> getReservas() throws IOException, ParseException{
		this.cargarReservas();
		return reservas;
	}
	...
	public ArrayList<Habitacion> habitacionesPorFecha(String fechaInicial, String fechaFinal) throws ParseException, IOException {
		this.cargarHabitaciones();
